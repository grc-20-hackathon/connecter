...
export const EMPLOYMENT_PROPERTY = 'BLCNN8nrcU6T6NLu2QDQtw';
export const FULL_STACK_ROLE = 'MAczhyCgJVF19JbZDAWULi';
export const TS_SKILL = 'KwpJNfJLxcYP5YUv6x5uyy';
export const JS_SKILL = 'Kps5ah1CJsTUeh7vCCj9dV';
